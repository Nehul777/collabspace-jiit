            ...
            <div className="mt-auto pt-4 border-t border-white/5 flex items-center justify-between">
              ...
              {!isMember && (
                <button
                  ...
                  className="px-3 py-1 bg-accent/10 hover:bg-accent text-accent hover:text-white border border-accent/20 rounded-lg text-xs font-medium transition-all"
                >
                  Request to Join →
                </button>
              )}
            ...
            <form onSubmit={handleQuickJoinSubmit} className="space-y-4">
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="px-4 py-1.5 bg-accent hover:bg-accent/90 text-white font-medium rounded-xl text-xs transition-colors disabled:opacity-50"
                >
